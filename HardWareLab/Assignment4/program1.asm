section .data
	string_count: db "Enter string input limit : 	"
	.length: equ $-string_count
	
	string_in: db "Enter string ",0Ah
	.length: equ $-string_in
	
	output: db "Sorted List:", 0Ah
	.length: equ $-output\
