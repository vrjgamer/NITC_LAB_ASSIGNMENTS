...
def getFuncValue(sigma, intensity):
    value = sigma * float(intensity) / 256
    value = np.exp(value)
    return value
...
plt.plot(iten)
plt.savefig('9B_graph_0.jpg')
plt.clf()
plt.cla()
plt.close()
IMG.fromarray(img, 'L').save('9B_0.jpg')
...
plt.plot(iten)
plt.savefig('9B_graph_1.jpg')
plt.clf()
plt.cla()
plt.close()
IMG.fromarray(img, 'L').save('9B_1.jpg')
...
plt.plot(iten)
plt.savefig('9B_graph_2.jpg')
plt.clf()
plt.cla()
plt.close()
IMG.fromarray(img, 'L').save('9B_2.jpg')
